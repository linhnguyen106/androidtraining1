package com.longch.example.training2.model;
...
public class Books {
    ...
    public Books(String id, List<String> cat, String name, String author, String series_t, int sequence_i, String genre_s, boolean inStock, double price, int pages_i) {
        this.id = id;
        this.cat = cat;
        this.name = name;
        this.author = author;
